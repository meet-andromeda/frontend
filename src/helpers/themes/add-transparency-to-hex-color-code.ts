const hexColorCodeForTransparency = {
  100: 'FF',
  99: 'FC',
  98: 'FA',
  97: 'F7',
...
interface AddTransparencyToHexColorCodeParams {
  colorCode: string;
  transparencyPercentage: keyof typeof hexColorCodeForTransparency;
}
...
function addTransparencyToHexColorCode({
  ...
  return colorCode + hexColorCodeForTransparency[transparencyPercentage];
}
